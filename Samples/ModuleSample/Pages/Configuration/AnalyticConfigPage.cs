...
{
    public class AnalyticConfigPage : ConfigPage
    {

        #region Public Fields

        public static readonly DependencyProperty CameraNameProperty =
            DependencyProperty.Register("CameraName", typeof(string), typeof(AnalyticConfigPage));
        ...
        protected override string Name => "Config Page 1";

        #endregion Protected Properties

        #region Public Constructors

        public AnalyticConfigPage()
        {
            View = new AnalyticConfigPageView(this);
        }
