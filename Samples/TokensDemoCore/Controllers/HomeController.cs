...
namespace WebApplicationCore.Controllers
{
        public class HomeController : Controller
    {
        ...
        {
            if (HttpContext.Session.GetString("SESSION_LOGIN")==null)
            {
                HttpContext.Session.SetString("SESSION_LOGIN","");
                Login();
            }
            else if (HttpContext.Session.GetString("SESSION_LOGIN").ToString() == "")
            {
                Login();
            }
        }
        ...
        private void OnEngineLoggedOn(object sender, LoggedOnEventArgs e)
        {
            ...
            HttpContext.Session.SetString("SESSION_LOGIN","loggedOn");
        }
